...
- `@waitkit/core`
  ...
  - 기본 이벤트 콜백
- `@waitkit/core@0.1.1` npm 배포 완료
- 외부 임시 프로젝트에서 설치, ESM/CJS import, 타입 선언 smoke test 완료
- 외부 테스트 앱에서 README 예제 적용 및 타입 확인 완료
- P0 첫 배포 안정화 완료
- `@waitkit/react` Provider/hook 기반 추가
